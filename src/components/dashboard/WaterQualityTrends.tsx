...
const WaterQualityTrends = () => {
  ...
  // Compact quality data
  const qualityData = {
    bellandur: {
      overall: 42, // Quality score out of 100
      ph: 7.2,
      oxygen: 4.8,
      turbidity: 15.3,
      pollutants: 8.2,
  ...
  const historicalData = [
    { month: "Jan", bellandur: 38, ulsoor: 65 },
    { month: "Feb", bellandur: 41, ulsoor: 67 },
    { month: "Mar", bellandur: 39, ulsoor: 64 },
    { month: "Apr", bellandur: 44, ulsoor: 69 },
    { month: "May", bellandur: 42, ulsoor: 68 }
  ];
